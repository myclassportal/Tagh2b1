const GameAudio = {
    ...
    speakIntro(dividend, divisor, onComplete) {
        const list = [
            'intro',
            ...this.numToFiles(dividend),
            'taqsim_bar',
    ...
    speakQuotient(dividend, divisor, quotient, onComplete) {
        const list = [
            ...this.numToFiles(dividend),
            'taqsim_bar',
            ...this.numToFiles(divisor),
    ...
    speakBorrow(onComplete) {
        this.playList(['qarz'], onComplete);
    },

    speakSubtractOnes(onComplete) {
        this.playList(['yekan'], onComplete);
    },

    speakSubtractTens(onComplete) {
        this.playList(['dahgan', 'payan'], onComplete);
    },
